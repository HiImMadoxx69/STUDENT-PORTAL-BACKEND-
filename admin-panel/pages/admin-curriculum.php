              ...
              <table class="table table-hover"  id ="tblUsers">
                <thead id ="tblThead">
                  <tr class="table-primary">
                    <th scope="col" class ="header-title" ><a href= "#" onclick ="sortCurrentTable('Subject_ID');return false;" class="th-a">ID</a></th>
                    <th scope="col" class ="header-title" ><a href= "#" onclick ="sortCurrentTable('Subject_Name');return false;" class="th-a">Name</a></th>
                    <th scope="col" class ="header-title" ><a href= "#" onclick ="sortCurrentTable('Subject_Code');return false;" class="th-a">Code</a></th>
                    <th scope="col" class ="header-title" ><a href= "#" onclick ="sortCurrentTable('Units');return false;" class="th-a">Unit</a></th>
                    <th scope="col" class ="header-title" ><a href= "#" onclick ="sortCurrentTable('Semester');return false;" class="th-a">Semester</a></th>
                    <th scope="col" class ="header-title" ><a href= "#" onclick ="sortCurrentTable('added_at');return false;" class="th-a">added at</a></th>
...
<script src ="../js/admin-course-section.js?t=1491313943549"  type = "text/javascript"></script>
