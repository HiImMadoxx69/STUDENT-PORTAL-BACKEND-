    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Archived Course</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card" >
            <div class="card-body" >
            <h5 class="card-title">Archived Course Table</h5>
      <!-- scroll table --> 
      <!-- Select Entry Page -->  
      ...
      <div class="row mb-3">
       ...
       <div class ="row mb-1">
<div class ="col-sm-2">
          <a href ="courses.php" class="btn btn-secondary" style ="margin:5px;">
              ...
              <table class="table table-hover"  id ="tblUsers">
                <thead id ="tblThead">
                  <tr class="table-primary">
                      <th scope="col" class ="header-title"><a href= "#" onclick ="sortCurrentTable('subject_code');return false;" class="th-a">COURSE NAME</a> </th>
                    <th scope="col" class ="header-title"><a href= "#" onclick ="sortCurrentTable('subject_name');return false;" class="th-a">COURSE FACULTY</a></th>
                    <th scope="col" class ="header-title"><a href= "#" onclick ="sortCurrentTable('units');return false;" class="th-a">CREDITS</a></th>
...
<script src ="../js/archived-course.js?t=1491313943549"  type = "text/javascript"></script>
