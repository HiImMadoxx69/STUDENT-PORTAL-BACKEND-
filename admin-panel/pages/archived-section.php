...
<li class="nav-item">
 ...
 <div class="alert alert-danger alert-dismissible fade" hidden role="alert" id="alertError" style ="position:fixed; z-index: 9999;width:fit-content; left:40%; top:10%;"> 
    ...
    <div class="pagetitle">
      <h1>Archived Section</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin-dashboard.php">Home</a></li>
          <li class="breadcrumb-item">Pages</li>
          <li class="breadcrumb-item active">Archived Section</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card" >
            <div class="card-body" >
            <h5 class="card-title">Archived Section Table</h5>
      <!-- scroll table --> 
      <!-- Select Entry Page -->  
      ...
      <div class="row mb-3">
       ...
       <div class ="row mb-1">
<div class ="col-sm-2">
          <a href ="section.php" class="btn btn-secondary" style ="margin:5px;">
              ...
              <table class="table table-hover"  id ="tblUsers">
                <thead id ="tblThead">
                  <tr class="table-primary">
                      <th scope="col" class ="header-title"><a href= "#" onclick ="sortCurrentTable('name');return false;" class="th-a">COURSE NAME</a> </th>
...
<script src ="../js/archived-section.js?t=1491313943549"  type = "text/javascript"></script>
