      ...
      <!-- End of Select Entry Page -->
              ...
              <table class="table table-hover"  id ="tblUsers">
                <thead id ="tblThead">
                  ...
                  <th scope="col" class ="header-title"><a href= "#" onclick ="sortCurrentTable('action');return false;" class="th-a">ACTIONS</a></th>
                    <th scope="col" class ="header-title"><a href= "#" onclick ="sortCurrentTable('added_at');return false;" class="th-a">DATE AND TIME</a></th>
                </thead>
...
<script src ="../js/audit.js?t=1491313943549"  type = "text/javascript"></script>
