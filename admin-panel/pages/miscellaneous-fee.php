    ...
    <div class="modal fade" id="basicModal" tabindex="-1">
              ...
              <div class="modal fade" id="addusermodal" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Miscellaneous Fee Create Form</h5>
              ...
              <form class="row g-3 needs-validation" id ="frmCreateUsers">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="number" class="form-control" id="newAmount" placeholder="Amount">
             ...
             <input class="form-control" type ="file" name = "profileEdit" id ="editUserPic" onchange="editProfilePic()">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Subject Update Form</h5>
              ...
              <input type="hidden" id="editId">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" class="form-control"  disabled id="editName" placeholder="Name" disabled>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card" >
            <div class="card-body" >
            <h5 class="card-title">Miscellaneous Fee</h5>
      <!-- scroll table --> 
      <!-- Select Entry Page -->  
...
<script src ="../js/miscellaneous-fee.js?t=1491313943549"  type = "text/javascript"></script>
