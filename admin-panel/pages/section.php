    ...
    <div class="modal fade" id="basicModal" tabindex="-1">
              ...
              <div class="modal fade" id="addusermodal" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Section Create Form</h5>
              ...
              <form class="row g-3 needs-validation" id ="frmCreateUsers">
                ...
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="newSection" placeholder="Section Name" required>
             ...
             <input class="form-control" type ="file" name = "profileEdit" id ="editUserPic" onchange="editProfilePic()">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Section Update Form</h5>
              ...
              <input type="hidden" id="editId">
                ...
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="editName" placeholder="Section Name">
...
<script src ="../js/section.js?t=1491313943549"  type = "text/javascript"></script>
