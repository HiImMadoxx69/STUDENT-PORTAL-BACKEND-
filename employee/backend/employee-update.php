...
if (isset($email)) {
 ...
 try{
                ...
                $rowAfter = json_encode($getAfter ->fetch_assoc());
                  ...
                  $auditsql = "INSERT INTO `tbl_history` (`action`,`category`,`editor_position`,`editor_email`,`edited_email`,`before_edit`,`after_edit`) VALUES ('$action','$category','$editPosition','$editEmail', '$email', '$rowBefore', '$rowAfter' );";
