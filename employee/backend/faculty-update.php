...
try{
    ...
    if (isset($CurrentId)) {
        ...
        $sql = "UPDATE `tbl_faculty` SET `faculty_name` = '$facultyName',`description` = '$Description',`status` = '$Status' WHERE `tbl_faculty`.`faculty_name` = '$Faculty';";
        ...
        $auditsql = "INSERT INTO `tbl_updatehistory` (`action`,`category`,`editor_position`,`editor_email`,`edited_email`,`after_edit`,`before_edit`) VALUES ('$Action','$Category','$EditorPosition','$EditorEmail', '$Faculty', '$rowAfter','$rowBefore');";
