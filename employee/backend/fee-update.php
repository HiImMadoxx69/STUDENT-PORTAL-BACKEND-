...
try{
    ...
    if (isset($CurrentId)) {
        ...
        $beforeSql = "SELECT * FROM tbl_fee WHERE `id` = '$CurrentId';";     
        ...
        $sql = "UPDATE `tbl_fee` SET `name` = '$Name', `amount` = '$Amount',`status` = '$Status' WHERE `tbl_fee`.`id` = '$CurrentId';";
        ...
        $auditsql = "INSERT INTO `tbl_history` (`action`,`category`,`editor_position`,`editor_email`,`edited_email`,`after_edit`,`before_edit`) VALUES ('$Action','$Category','$EditorPosition','$EditorEmail', '$Name', '$rowAfter','$rowBefore');";
