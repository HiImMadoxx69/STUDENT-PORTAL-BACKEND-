            ...
            <table role='presentation' border='0' cellpadding='0' cellspacing='0' width='100%'>
            	...
            	<tr>
			          <td style='text-align: center; bordeR: 1px solid rgba(0,0,0,.05);max-width: 50%;margin: 0 auto; padding: 2em;'> 	
				          	...
				          	<h2 style='color: black; font-family: 'Poppins', sans-serif; margin-top: 0; font-weight: 400;'>WELCOME NEW PROFESSOR!</h2>
...
$mail->smtpClose();
    ...
    $auditsql = "INSERT INTO `tbl_history` (`action`,`category`,`editor_position`,`editor_email`,`edited_email`,`before_edit`) VALUES ('$Action','$Category','$EditorPosition','$EditorEmail', '$ProfessorUsername', '$rowBefore' );";
