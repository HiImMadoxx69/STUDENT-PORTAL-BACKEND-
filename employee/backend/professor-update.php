...
try{
    ...
    if (isset($Username)) {
        ...
        $sql = "UPDATE `tbl_professor` SET `firstname` = '$FirstName', `middlename` = '$MiddleName',`lastname` = '$LastName',`faculty` = '$Faculty',` `status` = '$Status' WHERE `tbl_professor`.`professor_username` = '$Username';";
